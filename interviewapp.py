...
# Initialize session state variable to track user message count
if "user_message_count" not in st.session_state:
    st.session_state.user_message_count = 0
# Initialize session state variable to track feedback display
if "feedback_shown" not in st.session_state:
    st.session_state.feedback_shown = False
# Initialize session state variable to track chat completion
...
# Feedback stage after the interview is complete
# Show "Get Feedback" 
